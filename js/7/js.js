...
const snake = {
   ...
   * @param {int} maxX Максимальная позиция по оси X.
   * @param {int} maxY Максимальная позиция по оси Y.
   */
  makeStep(maxX, maxY) {
    ...
    this.body.unshift(this.getNextStepHeadPoint(maxX, maxY));
  ...
  getNextStepHeadPoint(maxX, maxY) {
    ...
    // Проверяем на выход за пределы поля и если нужно, переносим ...
    // ...по оси X
