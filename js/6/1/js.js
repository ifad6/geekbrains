...
const gallery = {
  settings: {
    ...
    imageErrorSrc: 'images/gallery/error.gif'
  },
  ...
  createScreenContainer() {
    ...
    // Вешаем отслеживание ошибки загрузки картинки
    image.addEventListener('error', () => this.error());
  ...
  /**
   * Заменяет картинку на заглушку при ошибке загрузки.
   */
  error() {
    const img = document.querySelector(`.${this.settings.openedImageClass}`);
    img.src = this.settings.imageErrorSrc;
  }
};
